...
if (isset($_POST['simpan'])) {
    ...
    header("Location: jadwal_uts.php");
    exit;
}
...
if (isset($_GET['hapus'])) {
    ...
    if ($id > 0) {
        $stmt = $conn->prepare("DELETE FROM jadwal_uts WHERE id_uts = ?");
...
<div class="main-content">
    ...
    <div class="topbar">
        <div class="topbar-left">
            <h2>Jadwal UTS</h2>
            <p>Kelola jadwal ujian tengah semester</p>
        </div>
    ...
    <div class="card">
        <div class="toolbar">
            <form method="GET" class="search-form">
                ...
                <a href="jadwal_uts.php" class="btn btn-yellow">
                            ...
                            <td>
                                <div class="action-group">
                                    <button
                                        ...
                                        type="button"
                                        onclick="editData(JSON.parse(this.dataset.uts))"
                                        data-uts="<?= $jsonData ?>"
                                    >
...
function editData(data) {
    ...
    document.getElementById("id").value = data.id_uts || "";
